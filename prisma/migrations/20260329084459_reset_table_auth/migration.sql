...
-- CreateIndex
CREATE INDEX "user_device_sessions_user_id_idx" ON "user_device_sessions"("user_id");
...
-- AddForeignKey
ALTER TABLE "user_device_sessions" ADD CONSTRAINT "user_device_sessions_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE;
